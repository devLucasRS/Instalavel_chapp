...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador Canal , selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar Canal \n"
  printf "   [1] Atualizar Canal P\n"
  printf "   [2] Deletar Canal \n"
  printf "   [3] Bloquear Canal P\n"
  printf "   [4] Desbloquear Canal \n"
  printf "   [5] Alter. dominio Canal \n"
  printf "\n"
  read -p "> " option
